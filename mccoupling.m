...
% Computes a number of coupling indices between two sets of mocap data using Principal Component Analysis (PCA) and Canonical Correlation Analysis (CCA).
%
% syntax
