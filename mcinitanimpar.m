...
%       el is changed to 10
%
% Note that the use of par3D.jointrotations requires that the mocap/joint structure contains an 'other.quat' field containing a time by component matrix where each marker/joint rotation is represented in quaternions using the 'scalar last' convention (X Y Z W). This field is automatically generated by mcread.m for Qualysis .tsv exports based on Theia3D markerless pose estimation.
%
